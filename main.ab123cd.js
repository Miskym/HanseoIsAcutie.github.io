...
this.bardle = this.bardle || {}, this.bardle.bundle = function(e) {
      ...
      .setting {\n \
           ...
           <section>\n  \
            ...
            <section>\n  \
                <div class="setting">\n   \
                 <div class="text">\n      \
                   <div class="title">Support More Shakespeare Games</div>\n  \
                 </div>\n   \
                  <div class="control">\n    \
                   <a href="https://ko-fi.com/shakespearegeek" title="Buy me a coffee">Buy me a coffee</a>\n   \
                  </div>\n  \
                 </div>\n  \
             </section>\n \
             </div>\n  <div id="footnote">\n    <div>\n          \n    </div>\n    <div>\n          </div>\n  </div>\n';
    var _a = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e, a = this;
                this.shadowRoot.appendChild(Sa.content.cloneNode(!0)), this.shadowRoot.addEventListener("game-switch-change", (function(e) {
                    e.stopPropagation();
                    var s = e.detail,
                        t = s.name,
                        o = s.checked,
    ...
    var Answers = ["hanse", "alarm", "horse", "knock", "phebe", "timon", "nonny", "world", "worms", "osric", "julia", "flesh", "crier", "casca", "drawn", "words", "cinna", "music", "feste", "bushy", "seems", "twins", "robin", "widow", "borne", "marry", "mirth", "exile", "percy", "varro", "titus", "heath", "stage", "aside", "angus", "roman", "ghost", "curan", "storm", "third", "drown", "hymen", "speed", "lance", "capon", "arden", "night", "boult", "lafeu", "crown", "prick", "essex", "menas", "blunt", "padua", "abbot", "ariel", "green", "snout", "james", "boyet", "thane", "unsex", "guilt", "friar", "quill", "egeus", "quote", "peter", "guard", "grave", "arras", "alack", "diana", "cupid", "folio", "ceres", "flute", "wound", "fault", "knock", "march", "viola", "stuff", "scene", "helen", "pedro", "groom", "fates", "lease", "paris", "curse", "ducat", "gower", "thief", "death", "brute", "woods", "beams", "actor", "sweet", "doubt", "blood", "sixth", "priam", "spite", "curio", "cheek", "peace", "sleep", "biron", "barge", "edgar", "parts", "drama", "glove", "maria", "thumb", "clerk", "waste", "groat", "angel", "trees", "magic", "snare", "caius", "shrew", "fools", "dream", "scars", "never", "great", "lewis", "romeo", "alice", "exits", "charm", "smile", "sword", "adieu", "speak", "civil", "mirth", "mercy", "corin", "aaron", "celia", "skull", "fatal", "roses", "nurse", "globe", "feast", "cheer", "quoth", "elbow", "rugby", "court", "tubal", "stars", "scout", "fifth", "henry", "clown", "plays", "regan", "lover", "cleon", "verse", "sooth", "fairy", "pound", "lucio", "sound", "blank", "queen", "witch", "uncle"],
        Ta = ['aaron','abase','abash','abate','abbey','abbot','abhor','abide','abler','abode','about','above','abram','absey','abuse','abuts','abysm','accit','aches','acorn','acres','acted','actor','acute','adage','added','adder','addle','adieu','admir','admit','adons','adopt','adore','adorn','adown','adsum','advis','aegle','aeson','aesop','aetna','afear','afire','afoot','afore','afric','after','again','agate','agent','agile','aglet','agone','agony','agood','agree','agued','agues','aided','aimed','ainsi','aired','alack','alarm','alban','alder','alias','alice','alien','alike','alive','allay','alley','allot','allow','aloft','alone','along','aloof','aloud','altar','alter','alton','alway','amain','amaze','amber','amble','amend','amiss','amity','among','amort','amour','ample','amply','ancle','ancus','angel','anger','anges','angle','angry','angus','anjou','annex','annoy','antic','anvil','apace','apart','apish','appal','appay','apple','apply','april','apron','apter','aptly','ardea','arden','argal','argue','argus','ariel','aries','arion','arise','armed','arose','arras','array','arriv','arrow','artus','asaph','ascii','asham','asher','ashes','aside','asked','asker','aspen','aspic','assay','asses','assez','assur','athol','atlas','atomy','atone','attir','aucun','audis','audit','auger','aught','aunts','aussi','autre','avail','avert','avoid','await','awake','award','awful','azure','babes','backs','bacon','badge','badly','bagot','baily','baits','baked','baker','bakes','balls','balms','balmy','bands','bandy','baned','banks','banns','bards','bared','barge','barks','barky','barne','barns','baron','basan','based','baser','bases','basin','basis','basta','batch','bated','bates','bathe','baths','batty','bavin','bawds','bawdy','beach','beads','beaks','beams','beans','beard','bears','beast','beats','becks','bedew','beefs','beest','befal','befit','began','beget','begin','begot','begun','being','belch','belie','belle','bells','belly','belov','below','bench','bends','bents','berri','berry','beset','besom','bessy','betid','bevel','bevis','bewet','biddy','bides','bight','bigot','bilbo','bills','binds','birch','birds','biron','birth','bitch','biter','bites','blabb','blabs','black','blade','blame','blanc','blank','blast','blaze','bleak','bleat','bleed','blent','bless','blest','blind','blink','bliss','bloat','block','blois','blood','bloom','blots','blown','blows','blues','blunt','blurr','blurs','blush','board','boars','boast','boats','boded','bodes','bohun','boils','bolds','bolts','bonds','boned','bones','bonne','bonny','bonos','bonto','bonum','books','boors','boots','booty','bored','bores','borne','bosak','bosko','bosky','bosom','botch','bough','boult','bound','bourn','bouts','bowed','bower','bowls','boxes','boyet','brace','brach','bracy','bragg','brags','braid','brain','brake','brand','brass','brats','brave','brawl','brawn','bread','break','breed','breff','brews','briar','bribe','brick','bride','brief','brier','brims','brine','bring','brink','brisk','broad','brock','broil','broke','brood','brook','broom','broth','brown','brows','bruit','brunt','brush','brute','bucks','budge','bugle','build','built','bulks','bulls','bully','bunch','burgh','burly','burns','burnt','burst','bushy','busky','butts','buxom','buyer','cabby','cabin','cable','cades','caelo','caged','caius','caked','cakes','calfs','calls','calms','camel','camps','candy','canis','canon','canst','capel','caper','capet','capon','carat','cards','cared','cares','caret','cargo','carol','carry','carts','carve','casca','cased','cases','casts','catch','cater','cates','caulk','cause','caves','cavil','cease','cedar','celia','celsa','cents','ceres','cerns','cesse','cette','chafe','chaff','chain','chair','chalk','champ','chang','chant','chaos','chape','chapp','chaps','chapt','chare','charg','charm','chary','chase','chats','chaud','cheap','cheat','check','cheek','cheer','chess','chest','chick','chide','chief','chien','child','chill','chime','china','chine','chink','chins','chipp','chips','choir','choke','chopp','chops','chopt','chose','chuck','churl','churn','cicel','cinna','circa','circe','cital','cited','cites','civet','civil','clack','claim','clang','clapp','claps','clare','clasp','claws','clean','clear','cleft','cleon','clepe','clept','clerk','cliff','cliii','climb','clime','cling','clink','clipp','clipt','cloak','clock','clogs','close','cloth','cloud','clout','clown','cloys','clubs','cluck','clung','coach','coals','coast','coats','cockl','cocks','codes','coeur','coign','coins','colic','colme','colts','comer','comes','comet','comic','comma','comme','compt','cooks','cools','coops','coped','copse','coral','coram','corbo','cords','corin','corky','corns','corse','cosmo','costs','coted','cotes','cotus','couch','coude','cough','could','count','court','cover','covet','cower','cozen','crabs','crack','craft','cramm','cramp','crams','crare','crash','crave','crawl','crazy','cream','credo','creed','creek','creep','crept','crest','crete','crews','cribb','cribs','cried','crier','cries','crime','crisp','croak','crone','crook','cropp','crops','cross','crost','crowd','crown','crows','cruel','crush','crust','cubit','cuffs','cuore','cupid','curan','curbs','curds','curdy','cured','curer','cures','curio','curls','curry','curse','curst','cynic','cyrus','daily','daisy','dally','dames','damns','damon','damps','dance','dandy','danes','dared','dares','darks','darts','dated','dates','daunt','deafs','deals','dealt','dears','death','debts','decay','decks','deeds','deems','deeps','defac','defer','defil','deign','deity','delay','delve','demon','denay','denis','denny','depth','derby','deriv','desir','deuce','devil','devin','devis','dials','diana','diced','dicky','didst','diest','dined','diner','dines','dirge','dirty','ditch','dites','ditty','dived','diver','dives','dizzy','docks','dodge','doers','doest','doing','doits','dolts','donne','dooms','doors','doted','dotes','doubt','dough','doute','douts','dover','doves','dowdy','dower','dowle','downs','downy','dowry','dozen','drabs','draff','dragg','drain','drake','drank','drave','drawn','draws','dread','dream','dregs','dress','drest','dried','drier','dries','drift','drily','drink','drive','droit','drone','droop','dropp','drops','dross','drove','drown','drugg','drugs','drums','drunk','ducat','duchy','ducks','dukes','dulls','dully','dumbe','dumbs','dumps','dungy','dunks','durst','dusky','dusty','dutch','dwarf','dwell','dwelt','dying','eager','eagle','earls','early','earns','earth','eased','eases','eaten','eater','eaves','ebony','ebook','ebrew','edgar','edged','edges','edict','egeus','egypt','eight','eisel','eject','elbow','elder','elect','ellen','elves','email','embay','ember','emmew','empty','enact','ended','endow','endue','endur','enemy','enjoy','enrag','ensky','ensue','enter','entre','entry','envoy','equal','erect','ereye','erjoy','error','errun','erset','ertop','essay','essex','evade','evans','event','every','evils','ewers','exact','exalt','excel','excus','exhal','exile','exion','exist','exits','expel','expir','extol','exton','exult','eyest','fable','faced','faces','facit','faded','fadge','fails','faint','fairs','fairy','faith','falls','fally','false','famed','fancy','fanes','fangs','fared','farer','fares','farms','fasts','fatal','fated','fates','fault','favor','fawns','fears','feast','feats','fecks','feeds','feels','feign','feith','fells','felon','fence','fends','fenny','ferry','feste','fetch','fever','fewer','fides','field','fiend','fiery','fifes','fifth','fifty','fight','figur','filch','filed','files','fills','filly','filth','finch','finds','fined','finem','finer','fines','finny','fired','fires','first','fists','fitly','fives','fixed','fixes','flags','flail','flaky','flame','flank','flash','flask','flats','flatt','flaws','fleas','fleer','fleet','flesh','flies','fling','flint','flirt','float','flock','flood','floor','flora','flote','flour','flout','flown','flows','flung','flush','flute','foals','foams','foamy','foggy','foils','foins','foist','folds','folio','folks','folly','fools','force','fordo','fords','fores','forge','forks','forms','forth','forts','forty','forum','found','fount','fowls','foxes','frail','frame','frank','fraud','frays','freed','freer','frees','fresh','frets','friar','frisk','frize','frock','front','frost','froth','frown','froze','fruit','frush','fully','fumes','furor','furze','fusty','gaffs','gaged','gagne','gains','galen','gales','galls','games','gamut','gaols','gapes','garde','gated','gates','gaudy','gauge','gaunt','gawds','gazed','gazer','gazes','geese','genoa','gests','ghost','giant','giber','gibes','giddy','gifts','gills','gipes','gipsy','girls','girth','given','giver','gives','glads','glare','glass','gleam','glean','gleek','glide','globe','glory','glose','gloss','glove','glows','gloze','glued','glues','gnats','gnawn','gnaws','goads','goals','goats','gobbo','godly','goers','goest','goeth','goffe','going','goods','goose','gored','gorge','goths','gourd','gouts','gouty','gower','gowns','grace','graff','graft','grain','grand','grant','grape','grasp','grass','grate','grave','gravy','graze','great','greed','greek','green','greet','grief','griev','grime','grind','gripe','grise','grize','groan','groat','groin','groom','gross','group','grove','grown','grows','grubb','grubs','gruel','grund','grunt','grype','guard','guess','guest','guide','guile','guilt','guise','gules','gulfs','gulls','gusts','gusty','gyved','gyves','habit','hacks','hadst','hagar','hairs','hairy','haled','hales','halts','hames','hands','handy','hangs','haply','happy','hardy','hares','harms','harpy','harry','harsh','harts','harum','haste','hasty','hatch','hated','hater','hates','haunt','haven','haver','havoc','hawks','hazel','heads','heady','heals','heaps','heapt','heard','hears','heart','heath','heats','heave','heavy','hedge','heels','hefts','heigh','heirs','helen','helms','helps','hence','henri','henry','herbs','herds','heren','herne','herod','hests','heure','hewgh','hides','hiems','hight','hillo','hills','hilts','hinds','hinge','hired','hiren','hives','hoard','hoars','hoary','hobby','hodge','hoise','hoist','holds','holes','holla','holly','homes','honey','hoods','hoofs','hooks','hoops','hoots','hoped','hopes','horns','horse','horum','hosts','hotly','hound','hours','house','hovel','hover','howls','howso','hoxes','hujus','hulks','human','hunts','hurly','hurry','hurts','husks','hutch','hybla','hydra','hymen','hymns','ideas','idiot','idles','ignis','ilbow','ilion','ilium','image','imbar','imply','incur','index','india','indue','infer','inkle','inlay','inset','inter','intil','inure','inurn','ionia','irish','irons','isbel','isles','issue','italy','items','ivory','jacet','jacks','jacob','jaded','jades','jakes','james','janus','jaunt','jelly','jenny','jerks','jeshu','jests','jesus','jewel','jewry','jills','johns','joins','joint','jolly','jovem','jowls','joyed','judas','judge','juice','julia','julio','julla','jumps','junes','juror','justs','jutty','kated','kates','keech','keels','keeps','kerns','ketly','kibes','kicky','kills','kinds','kings','kites','knack','knave','knead','kneel','knees','knell','knife','knits','knobs','knock','knoll','knots','known','knows','laban','label','labeo','laced','laces','lacks','laden','lafeu','lakes','lakin','lambs','lamed','lames','lamps','lance','lands','lanes','lapis','lapse','lards','large','larks','larum','lasts','latch','lated','later','latin','laugh','laund','laura','lavee','lawns','layer','lazar','leads','leafy','leaky','leans','leaps','learn','lease','leash','least','leave','lecon','leech','leeks','leers','leese','leets','legal','leges','leman','lemon','lends','leper','lethe','level','leven','lewis','liars','libya','licio','liege','liest','lieth','lieve','lifts','light','liked','liken','liker','likes','limbo','limbs','limed','limit','limps','lined','linen','lines','links','linta','lions','lists','lived','liver','lives','livia','loach','loads','loath','lobby','local','locks','lodge','lofty','logic','loins','lolls','longs','looks','loose','lords','lorum','loser','loses','lours','louse','lousy','louts','loved','lovel','lover','loves','lower','lowly','loyal','lozel','luces','lucio','lucky','lucre','lulla','lulls','lunes','lungs','lurch','lurks','lusts','lusty','lutes','lydia','lying','maces','madam','madly','madst','magic','magni','magot','maids','mails','maims','maine','mains','major','maker','makes','males','manes','mangy','manka','manly','manna','manor','manus','march','mares','marge','maria','marks','marle','marry','marsh','marts','masks','mason','massy','masts','match','mated','mater','mates','matin','mauri','maxim','mayor','mayst','mazed','mazes','meads','meals','mealy','means','meant','meats','medal','medea','media','meeds','meets','meiny','melts','melun','menas','mends','menon','mercy','merit','merry','metal','metre','mette','midas','midst','might','milan','milch','miles','milks','milky','mille','mills','mimic','mince','minds','mines','minim','minos','mints','mired','mirth','miser','mista','mists','misty','mites','moans','mocks','model','moist','moles','molto','monde','money','monks','month','moods','moody','moons','moors','mopsa','moral','moreo','mores','motes','moths','mothy','motto','mould','moult','mount','mourn','mouse','mouth','moved','mover','moves','mower','muddy','mules','mummy','munch','mural','murky','mused','muses','music','musty','mutes','nails','naked','named','names','napes','nasty','nated','navel','nebor','necks','nedar','needs','needy','neeld','neeze','nefas','negro','neigh','nerve','nervy','nests','never','nevil','newer','newly','newts','nicer','nicks','niece','night','nihil','nilus','ninny','ninth','ninus','niobe','nobis','noble','nobly','noces','noddy','noise','nonce','nonny','nooks','north','nosed','noses','noted','notes','notre','nouns','novel','novum','numbs','nurse','nursh','nymph','oaken','oaten','oaths','obeys','occur','ocean','oddly','odour','offal','offer','often','olden','older','olive','omans','omitt','omnes','onion','onset','oozes','opens','orbed','order','organ','osier','osric','other','otter','ought','ounce','ousel','outgo','overt','owest','oweth','owing','owlet','owner','paced','paces','packs','padua','pagan','pages','pails','pains','paint','pairs','paled','paler','pales','palms','palmy','palsy','panel','pangs','pansa','pants','panyn','paper','parca','parch','pared','parel','paris','parks','parle','parti','parts','party','passy','paste','pasty','patay','patch','pated','pates','paths','pauca','pause','paved','pawns','peace','peach','peard','pearl','pears','pease','pecks','pecus','pedro','peeps','peers','peise','peize','pella','pence','penny','pense','pepin','perch','percy','perdu','perdy','perge','peril','perus','peter','petit','petre','petty','pglaf','phebe','philo','pible','picks','pickt','piece','pierc','piers','piety','pight','pigmy','pikes','pilch','piled','piles','pills','pilot','pinch','pined','pines','pinse','pious','piper','pipes','pitch','pithy','pitie','place','plack','plain','plant','plash','plate','plats','plays','plead','pleas','plebs','pless','plied','plies','plods','plood','plots','pluck','plume','plump','plums','pluto','pocky','poesy','poets','poins','point','poise','poles','pomps','ponds','poppy','porch','ports','posse','posts','potch','pouch','pound','pours','power','powle','prain','prais','prank','prate','prave','prays','pread','press','prest','preys','priam','price','prick','pride','prief','pries','prime','primo','primy','print','privy','prize','prone','proof','propp','props','prose','proud','prove','prune','psalm','puffs','pulls','pulse','pumps','punto','pupil','puppy','purer','purge','purse','pursy','purus','quaes','quaff','quail','quake','qualm','quand','quare','quart','quasi','quean','queas','queen','quell','quern','quest','quick','quies','quiet','quill','quilt','quips','quire','quirk','quite','quits','quods','quoif','quoit','quote','quoth','racks','raged','rages','rails','rains','rainy','raise','raked','rakes','ralph','ramps','range','ranks','rapes','rarer','rated','rates','raved','ravel','raven','raves','ravin','rawer','rawly','rayed','razed','razor','reach','reads','ready','realm','reaps','rears','reave','rebel','rebuk','recks','recur','reeds','reedy','reeks','reeky','reels','refer','regal','regan','regia','reign','reins','remit','remov','rends','renew','rents','repay','repel','reply','rests','resty','revel','rheum','rhyme','rider','rides','ridge','rifle','right','rigol','rigor','rings','riots','ripen','riper','risen','rises','rites','rival','rived','river','rivet','roads','roars','roast','robas','robed','robes','robin','rocks','rocky','roger','rogue','rolls','roman','romeo','roofs','rooks','rooky','rooms','roots','ropes','rosed','roses','rouen','rough','round','rouse','route','routs','rover','rowel','royal','ruddy','ruder','ruffs','rugby','ruins','ruled','ruler','rules','rumor','rural','rushy','rusts','rusty','sable','sacks','sadly','safed','safer','sails','saint','saith','sakes','salad','sally','salve','sands','sandy','sapit','sappy','sarum','satan','sated','satin','satis','satyr','sauce','saucy','saved','saves','savor','savoy','sawed','sayst','scabs','scald','scale','scall','scalp','scaly','scann','scant','scape','scare','scarf','scarr','scars','scath','scene','scent','scion','scoff','scold','scone','scope','score','scorn','scots','scour','scout','scowl','screw','scrip','scuds','scuse','seals','seams','seamy','seats','sects','sedge','sedgy','seeds','seeks','seely','seems','seese','seest','seeth','seize','sells','sends','senis','sense','serge','serve','sessa','seven','sever','sewed','sewer','sfoot','shade','shady','shaft','shake','shall','shalt','shame','shank','shape','shard','share','shark','sharp','shave','sheaf','shear','sheds','sheen','sheep','sheer','sheet','shelf','shell','shent','shews','shift','shill','shine','shins','shiny','shipp','ships','shire','shirt','shive','shoal','shock','shoes','shone','shook','shoon','shoot','shops','shore','shorn','short','shout','shove','shown','shows','shrew','shrub','shrug','shunn','shuns','shuts','sibyl','sicil','sided','sides','siege','sieve','sighs','sight','signs','silks','silly','simon','since','sinel','sinew','singe','sings','sinks','sinon','siren','sixth','sixty','sized','sizes','skein','skies','skill','skins','skipp','skips','skirr','skull','skyey','slack','slain','slake','sland','slash','slave','slays','sleek','sleep','slept','slice','slide','slily','slime','slimy','slink','slipp','slips','slipt','slish','slope','slops','sloth','slunk','sluts','smack','small','smart','smear','smell','smelt','smile','smite','smith','smock','smoke','smoky','smote','snail','snake','snaky','snare','snarl','sneak','sneap','sneck','snipe','snipt','snore','snout','snowy','snuff','soaks','soars','sober','socks','soils','soled','soles','solid','solon','solum','solus','somme','songs','sooth','sooty','sophy','sorel','sorer','sores','sorry','sorts','sould','souls','sound','sours','souse','south','space','spade','spain','spake','spann','spans','spare','spark','spawn','speak','spear','speed','spell','spelt','spend','spent','sperm','spero','sperr','spice','spied','spies','spill','spilt','spire','spirt','spite','spits','splay','split','spoil','spoke','spoon','sport','spots','spout','sprag','sprat','spray','spuns','spurn','spurr','spurs','stabb','stabs','staff','stage','stags','stain','stair','stake','stale','stalk','stall','stamp','stand','stare','stark','starr','stars','start','state','stays','stead','steal','steam','steed','steel','steep','steer','stell','stepp','steps','stern','stews','stick','stiff','stile','still','sting','stink','stint','stirr','stirs','stock','stole','stone','stony','stood','stool','stoop','stopp','stops','stopt','store','storm','story','stoup','stout','stows','straw','stray','strew','strip','striv','stroy','strut','stuck','studs','study','stuff','stump','stung','stunk','styga','style','subdu','sucks','sueth','sugar','suing','suits','sully','summa','sunny','super','surer','surge','surly','susan','swain','swamp','swans','sward','sware','swarm','swart','swath','sways','swear','sweat','sweep','sweet','swell','sweno','swept','swift','swill','swims','swine','swing','swirl','swoln','swoon','swoop','sword','swore','sworn','swung','sylla','synod','syria','taber','table','tails','taint','taken','taker','takes','tales','talks','tally','talon','tamed','tamer','tames','tanta','taper','tardy','targe','tarre','tarry','tasks','taste','taunt','tawny','taxed','taxes','teach','tears','teems','teeth','tells','temps','tempt','tench','tends','tenor','tenth','tents','terms','terra','terre','testy','tevil','texts','thane','thank','thaws','theft','their','theme','there','these','thews','thick','thief','thigh','thine','thing','think','third','thoas','thong','thorn','those','three','threw','throb','throe','throw','thrum','thumb','thump','thyme','tiber','ticed','tides','tiger','tight','tilly','tilth','tilts','timed','times','timon','timor','tinct','tipsy','tired','tires','tirra','titan','tithe','title','titus','toads','toast','toaze','today','toged','toils','token','tombe','tombs','tongs','tongu','tools','tooth','topas','topsy','torch','total','touch','tough','tours','touse','tower','towns','trace','track','tract','trade','trail','train','trapp','traps','trash','tread','treat','trees','trent','treys','trial','tribe','trice','trick','tried','trier','tries','trill','trimm','trims','tripe','tripp','trips','troat','troll','troop','troth','trots','trout','truce','truer','truie','trull','truly','trump','trunk','trust','truth','tubal','tufts','tully','tuned','tunes','tunis','turfy','turks','turns','turph','turvy','tutor','tutto','tutus','twain','tween','twere','twice','twigs','twill','twine','twink','twinn','twins','twire','twist','twits','twixt','tying','types','tyrus','ulcer','umber','umbra','unapt','unarm','unask','unbar','unbid','unbow','uncle','under','undid','unear','unfed','unfee','unfit','unfix','ungot','union','unite','unity','unliv','unmix','unpay','unpeg','unpin','unrip','unsay','unset','unsex','untie','until','untun','unvex','unwed','unwoo','upper','urged','urges','urine','usage','usest','useth','usher','using','usual','usurp','usury','utter','vaded','vails','vales','value','varld','varro','vasty','vater','vault','vaunt','vehor','veins','venge','venit','venom','vents','venue','venus','verba','verbs','verge','verse','vetch','vexed','vexes','vials','viand','vicar','viced','vices','video','vides','views','vigil','viler','vines','viola','viper','virgo','virus','visit','visor','vitae','vital','vixen','voice','vomit','vorld','votre','vouch','vowed','vowel','vulgo','waded','wafer','wafts','waged','wager','wages','wagon','wails','waist','waits','waked','waken','wakes','wales','walks','walls','wands','waned','wanes','wants','wards','wares','warms','warns','wasps','waste','watch','water','waved','waver','waves','waxed','waxen','waxes','wears','weary','weave','weeds','weedy','weeks','weeps','weigh','weird','wells','welsh','wench','whale','wharf','whate','wheat','wheel','whelk','whelm','whelp','whene','where','which','whiff','while','whine','whipp','whips','whipt','whirl','whist','white','whole','whoop','whore','whose','whoso','wicky','wider','widow','wield','wight','wilds','wiles','wills','wince','winds','windy','wings','winks','wiped','wipes','wires','wiser','witch','witty','wived','wives','woful','woman','wombs','womby','women','woods','wooed','wooer','wooes','words','works','worky','world','worms','wormy','worry','worse','worst','worth','worts','would','wound','wouns','woven','wrack','wrapp','wraps','wrapt','wrath','wreak','wreck','wrens','wrest','wring','wrist','write','writs','wrong','wrote','wroth','wrung','yards','yearn','years','yells','yesty','yield','yoked','yokes','yorks','young','yours','youth','zeals'],
        Ia = "present",
        Ma = "correct",
        Oa = "absent";
    var Ra = {
    ...
    function Da(e) {
        var a, s = Ga(e);
        return a = s % Answers.length, Answers[a]
    }
         ...
         <div class="menu">\n   \
              ...
              <div class="title">\n         BARDLE\n        </div>\n    \
                  <div class="menu">\n    \
                    ...
                    <button id="tip-button" class="icon" aria-label="tip">\n      \
            ...
            return o(t, [{
                ...
                value: function() {
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        if (e = s, !Ta.includes(e) && !Answers.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not in word list");
                        if (this.hardMode) {
                ...
                value: function() {
                    ...
                    })), this.shadowRoot.getElementById("tip-button").addEventListener("click", (function(a) {
                      window.open('http://ko-fi.com/shakespearegeek', '_blank');
    ...
    var Bs = {
            ...
            tip: "M 15.019343,10.141073 V 7.2688028 c 0.804651,0.05895 1.432953,0.8713939 \
         1.507271,1.701013 h 2.672177 c 0.003,-2.7892313 -2.489782,-4.2554811 -4.20716,-4.36338 V 2.7242237 H 12.44315 v 1.8822121 c -0.749983,0.00592 -4.1290628,0.978269 -4.1252839,4.0981173 -0.00403,2.7766729 2.4328469,3.5342739 4.1252839,3.7777519 v 3.13702 C 11.210225,15.26436 10.9845,14.29865 10.812435,13.500556 H 8.0991946 c 0.1738288,3.121642 2.8699374,4.57482 4.3439554,4.797795 v 1.924757 h 2.576445 v -1.896565 c 2.037323,-0.111996 4.45052,-1.90169 4.454047,-4.350053 -0.0038,-2.815886 -2.407655,-3.614237 -4.454047,-3.833111 z M 12.456502,9.6802588 c -1.813865,-0.028704 -1.850143,-2.0513655 0,-2.3840327 z m 2.590553,5.9536752 v -2.705167 c 2.247177,0.06279 2.497339,2.342513 0,2.704911 z"
        },
        Fs = function(e) {
            r(t, e);
            var a = h(t);
